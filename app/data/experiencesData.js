...
export const experiencesData = [ 
  ...
  },
  {
    ...
    description: 'As a Full-Stack Developer at Melot Group, I specialize in creating responsive and intuitive web applications. My expertise spans across front-end frameworks like Vue.js and React.js, while I utilize Node.js (Express.js), MongoDB Atlas, and AWS services for the backend infrastructure.',
